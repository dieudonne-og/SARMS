...
?>
 <?php
  ...
  function getBehaviorMarks($studentId = 0, $term=2){
    global $dbCon;
...
<head>
  ...
  <title><?php echo ucfirst($studentInfo['studentname']);  ?> 2nd term Report</title>
  <style type="text/css">
    <!--
...
.style15 {font-family: Verdana, Arial, Helvetica, sans-serif; font-weight: bold; font-size: 12px; }
...
<table width="252" border="0" align="right">
        ...
        <tr>
          <td colspan="20">
          <div align="center" class="style13"><strong>LEARNER'S ASSESSMENT REPORT</strong></div>          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td valign="top"><span class="style13">Module weight </span>            </p>                    </td>
...
$totalweight=0;
        foreach (getSubjectListAccordingToSubjectType($studentId, 1) as $subjectInfo) {
         ...
         $weight=number_format($subjectInfo['weight']);
          $totalAnnualPercentage=number_format(($totalTerm2)/number_format($weight)*100,2);
      ...
      <?= $decision ?>
        ...
        <tr>
          <td colspan="19">
          <div align="center" class="style13"><strong>CORE MODULES</strong></div>          </td>
        </tr>
        <tr>
      ...
      <?= $decision ?>
        ...
        <tr>
          ...
          <td><span class="style13">&nbsp;
          <?= $totalTerm2Type1+$totalTerm2Type3 ?>
          </span></td>
      <td>&nbsp;</td>
...
<?=round(($totalTerm2Type1+$totalTerm2Type3)*100/($totalweight1+$totalweight2+$totalweight3 ), 2) ?>
%</strong></span></td>
      </tr>
        
        <tr>
          <td height="19" colspan="2"><span class="style15"><strong>POSITION</strong></span></td>
          <td colspan="10"><div align="center" class="style13"><strong><?= getStudentPosition($studentId,"term2"); ?></strong>&nbsp;</div></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <div align="center"><strong>SCHOOL MANAGER </strong>:</div></td>
        </tr>
</table>
