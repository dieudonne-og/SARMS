...
$classid=$_SESSION['alogin'];
    $sql ="SELECT Password,classid FROM admin WHERE classid=:classid and Password=:Password";
...
if($query -> rowCount() > 0)
{
$con="update admin set Password=:newpassword where classid=:classid";
$chngpwd1 = $dbh->prepare($con);
$chngpwd1-> bindParam(':classid', $classid, PDO::PARAM_STR);
