...
<head>
  ...
  <title><?php echo ucfirst($studentInfo['studentname']);  ?> 1st term Report</title>
  <style type="text/css">
    <!--
...
%</strong></span></td>
        ...
        <tr>
          ...
          <td colspan="10"><div align="center" class="style13"><strong><?= getStudentPosition($studentId,"term1"); ?></strong>&nbsp;</div></td>
        </tr>
        <tr>
