...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['addBeResultForm'])) {
        $marks = array();
        $classId = $_POST['class'];
        ...
        $query = $dbh->prepare("SELECT academicYear,ClassId,term FROM tblbehavior WHERE  academicYear=:academicYear and ClassId=:class   ");
        $query->bindParam(':academicYear', $academicYear, PDO::PARAM_STR);
        $query->bindParam(':class', $classId, PDO::PARAM_STR);
        if ($query->rowCount() > 0) {
            $error= "Behavior Marks already recorded for this term ";
        } else {
            foreach ($marksArr as $studentId => $subjectMarks) {
                $sql = "INSERT INTO  tblbehavior(StudentId,academicYear,ClassId,SubjectId,marks,term,type) VALUES(:studentid,:academicYear,:class,:subjectid,:marks,:term,:type)";
...
?>
    ...
    <head>
        ...
        <title> Add Behavior Marks </title>
                    ...
                    <div class="main-page">
                        ...
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Declare Behavior Marks </h2>
  ...
  <?php echo htmlentities($result->class); ?>                                                                   
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-offset-2 col-sm-10">
                                                        <button type="submit" name="addBeResultForm" id="submit" class="btn btn-primary">Save marks <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-save" viewBox="0 0 16 16">
                ...
                $(document).ready(function() {
                    ...
                    $(document).on("change", "#studentid", function() {
                        ...
                        $.ajax({
                            ...
                            url: "get_student.php",
                            data: {
                                act: 'getStudentPrevbehMarksStatus',
