...
{   ?>                                                    
 ...
 <input type="text" name="subjectcode" class="form-control" id="default" placeholder="Message title" required="required">
                                                        ...
                                                        <div class="col-sm-10">
    <div class="col-sm-10">
                                                   <textarea  name="type" class="form-control" id="default" placeholder="Type your message here!......" required="required" style="width: 200px;"></textarea><button type="submit" name="submit" class="btn btn-primary">Send</button>
                                                </div>
                                                    </div>
