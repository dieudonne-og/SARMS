...
<td>
<a href="edit-class.php?classid=<?php echo htmlentities($result->id);?>">  <button type="button" class="btn btn-primary btn-sm"><i class="fa fa-edit" title="Edit Record"> Edit</i> </a>
