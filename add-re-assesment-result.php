...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['addReResultForm'])) {
        $marks = array();
        $classId = $_POST['class'];
        ...
        $query = $dbh->prepare("SELECT SubjectId,ClassId,term,type FROM tbl_reassessment_result WHERE SubjectId=:subjectid and academicYear=:academicYear and ClassId=:class and term=:term and type=:type  ");
        ...
        if ($query->rowCount() > 0) {
            ...
            foreach ($marksArr as $studentId => $subjectMarks) {
                $sql = "INSERT INTO  tbl_reassessment_result(StudentId,academicYear,ClassId,SubjectId,marks,term,type) VALUES(:studentid,:academicYear,:class,:subjectid,:marks,:term,:type)";
...
?>
    ...
    <head>
        ...
        <title> Add Re-Assessment Marks </title>
                    ...
                    <div class="main-page">
                        ...
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Declare Re-Assessment Marks </h2>
...
<li class="active">Results</li>
                                        <li class="active"> Re-Assessment marks</li>
                                    </ul>
                                </div>
...
<div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-offset-2 col-sm-10">
                                                        <button type="submit" name="addReResultForm" id="submit" class="btn btn-primary">Save marks <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-save" viewBox="0 0 16 16">
            ...
            <script>
                ...
                $(document).ready(function() {
                    ...
                    $(document).on("change", "#selectTerm", function() {
                        ...
                        if (selectTermId > 0) {
                            $("#assessmentType").html(`<option value="">Select </option>
                                                        <option value="1">Re- Assessment</option>`);
                        } else {
                            $("#assessmentType").html(`<option value="">Select </option>`);
                        }
                        $("#reslt").html("");
